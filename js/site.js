...
function finalizarCalculo() {
    ...
    // Diferença
    $('#diferenca').html(($('#resultado-sujo-7')+$('#resultado-sujo-6')+$('#resultado-sujo-5')+$('#resultado-sujo-4')+$('#resultado-sujo-3')+$('#resultado-sujo-2'))-($('#resultado-limpo-7')+$('#resultado-limpo-6')+$('#resultado-limpo-5')+$('#resultado-limpo-4')+$('#resultado-limpo-3')+$('#resultado-limpo-2')))
